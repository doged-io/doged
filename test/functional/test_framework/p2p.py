...
"""Test objects for interacting with a dogecashd node over the p2p protocol.

The P2PInterface objects interact with the dogecashd nodes under test using the
