...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_dogecash-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_dogecash-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_dogecash-qt  # macOS
...
void WalletTests::walletTests() {
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN(
            ...
            "test_dogecash-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
