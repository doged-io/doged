...
public:
    ...
    //! Temporary CCoinsViewCache layered on top of m_cacheview and passed to
    //! ConnectBlock(). Reset between calls and flushed only on success, so
    //! invalid blocks don't pollute the underlying cache.
