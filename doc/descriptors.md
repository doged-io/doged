# Support for Output Descriptors in doged

Since doged v0.20.7, there is support for Output Descriptors. This is a
...
existing doged wallets, a convenience function `combo` is provided,
...
All RPCs in doged will include the checksum in their output. Only
