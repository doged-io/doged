...
Multiple tools can list the available tracepoints in a `dogecashd` binary with
USDT support.
...
stap net        inbound_message  0x000000000014419e /src/dogecashd
stap net        outbound_message 0x0000000000107c05 /src/dogecashd
stap validation block_connected  0x00000000002fb10c /src/dogecashd
…
```
...
```
$ readelf -n ./src/dogecashd | grep NT_STAPSDT -A 4 -B 2
