UNIX BUILD NOTES
====================
Some notes on how to build doged in Unix.
...
*Note: doged provides a [Docker image with all the dependencies preinstalled](#build-using-a-docker-container).*
...
memory available when compiling doged. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build doged without wallet.
...
Security
--------
To help make your doged installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, doged should be built with a non-executable stack,
