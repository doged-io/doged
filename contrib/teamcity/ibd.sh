...
#
# Runs a dogecashd process until initial block download is complete.
# Forwards the exit code from dogecashd onward.
###
...
DOGECASHD="${DOGECASHD}" \
LOG_FILE="${DEBUG_LOG}" \
"${TOPLEVEL}/contrib/devtools/dogecashd-exit-on-log.sh" \
